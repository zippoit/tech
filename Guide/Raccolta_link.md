...
### Windows
- [PowerView-3.0 tips and tricks · GitHub](https://gist.github.com/HarmJ0y/184f9822b195c52dd50c379ed3117993)

### Shodan searches
- [Set-Cookie: iomega= - Shodan Search](https://www.shodan.io/search?query=Set-Cookie%3A+iomega%3D)
- [title:SecuritySpy - Shodan Search](https://www.shodan.io/search?query=title%3ASecuritySpy)
...
- [Default Router Passwords - The internet's most comprehensive router password database](http://www.routerpasswords.com/)
- [NirSoft - freeware utilities: password recovery, system utilities, desktop utilities](http://www.nirsoft.net/)
- [Online Password Calculator](http://lastbit.com/pswcalc.asp)
- [Top 100 most common passwords - techlabuzz.com](https://techlabuzz.com/top-100-most-common-passwords/)
...
- [GitHub - knavesec/CredMaster](https://github.com/knavesec/CredMaster): Refactored & improved CredKing password spraying tool, uses FireProx APIs to rotate IP addresses, stay anonymous, and beat throttling
- [GitHub - dafthack/MailSniper](https://github.com/dafthack/MailSniper): MailSniper is a penetration testing tool for searching through email in a Microsoft Exchange environment for specific terms (passwords, insider intel, network architecture information, etc.)

### Additional Resources

- [Footprinting - HackTips](https://hacktips.it/footprinting/)
...
- [Nuova scheda](http://pipl.com/)
- [The World's Largest Repository of Historical DNS data](https://securitytrails.com/)
- [IP Logger URL Shortener - Log and Track IP addresses](https://iplogger.org/)
- [Webpage archive](https://archive.fo/)
- [Daily Historical Screenshots | CompetitorScreenshots.com](https://www.competitorscreenshots.com/)
- [Censys](https://censys.io/)
- [ZoomEye - Cyberspace Search Engine](https://www.zoomeye.org/)
- [Nmap Cheat Sheet](https://highon.coffee/blog/nmap-cheat-sheet/)
- [Infoga](https://awesomeopensource.com/project/m4ll0k/Infoga)
- [finger | Penetration Testing Lab](https://pentestlab.blog/tag/finger/)
- [Active Directory Security](https://adsecurity.org/)
- [cPassword | Penetration Testing Lab](https://pentestlab.blog/tag/cpassword/)
- [Online Access DB Opener](https://www.mdbopener.com/)
- [GitHub - TheRook/subbrute](https://github.com/TheRook/subbrute): A DNS meta-query spider that enumerates DNS records, and subdomains.
- [GitHub - DedSecInside/TorBot](https://github.com/DedSecInside/TorBot): Dark Web OSINT Tool
- [GitHub - ffuf/ffuf](https://github.com/ffuf/ffuf): Fast web fuzzer written in Go
...
- [GitHub - thelinuxchoice/instashell: Multi-threaded Instagram Brute Forcer without password limit](https://github.com/thelinuxchoice/instashell)
...
- [Weakpass](https://weakpass.com/wordlist/big)

### Cheatsheets

- [Penetration Testing Cheat Sheet - Penetration Testing Tools, ML and Linux Tutorials](https://reconshell.com/penetration-testing-cheat-sheet/)
...
- [GitHub - payloadbox/command-injection-payload-list: 🎯 Command Injection Payload List](https://github.com/payloadbox/command-injection-payload-list)
- [OSCP preparation cheat sheets - Penetration Testing Tools, ML and Linux Tutorials](https://reconshell.com/oscp-preparation-cheat-sheets/)
...
- [GitHub - mzet-/linux-exploit-suggester: Linux privilege escalation auditing tool](https://github.com/mzet-/linux-exploit-suggester)
...
- [GitHub - linted/linuxprivchecker: linuxprivchecker.py -- a Linux Privilege Escalation Check Script](https://github.com/linted/linuxprivchecker)
- [GTFOBins](https://gtfobins.github.io/)
- [Basic Linux Privilege Escalation - g0tmi1k](https://blog.g0tmi1k.com/2011/08/basic-linux-privilege-escalation/)
- [linux-smart-enumeration/lse.sh at master · diego-treitos/linux-smart-enumeration · GitHub](https://github.com/diego-treitos/linux-smart-enumeration/blob/master/lse.sh)

### Windows

- [Windows Privilege Escalation Fundamentals](http://www.fuzzysecurity.com/tutorials/16.html)
- [Windows Zero-Day PoC Lets You Read Any File with System Level Access](https://www.bleepingcomputer.com/news/security/windows-zero-day-poc-lets-you-read-any-file-with-system-level-access/)
- [GitHub - scipag/nac_bypass: Script collection to bypass Network Access Control (NAC, 802.1x)](https://github.com/scipag/nac_bypass)
...
- [GitHub - antonioCoco/RogueWinRM: Windows Local Privilege Escalation from Service Account to System](https://github.com/antonioCoco/RogueWinRM)
- [Potatoes - Windows Privilege Escalation · Jorge Lajara Website](https://jlajara.gitlab.io/Potatoes_Windows_Privesc)
- [Decoder's Blog – IT Security Tips and Tricks](https://decoder.cloud/)
...
- [GitHub - Screetsec/TheFatRat: Thefatrat a massive exploiting tool : Easy tool to generate backdoor and easy tool to post exploitation attack like browser attack,dll . This tool compiles a malware with popular payload and then the compiled malware can be e](https://github.com/Screetsec/TheFatRat)

### Reporting

- [Come scrivere un Report per il Pentesting - Hacking Facile](https://www.hackingfacile.it/come-scrivere-un-report-del-pentesting/)
...
- [GitHub - michelin/ChopChop: ChopChop is a CLI to help developers scanning endpoints and identifying exposition of sensitive services/files/folders.](https://github.com/michelin/ChopChop)
- [Birb - Faster Web Discovery – Ringtail Security](https://ringtail.ch/pages/birb-faster-web-discovery)
